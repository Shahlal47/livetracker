<div class="portlet light">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-gift"></i>Division List</div>
        <div class="tools">
    ...
    <div class="portlet-window-body">
        <?= $this->Html->link('Add New Division', ['action' => 'add'], ['class' => 'btn btn-default']) ?><br><br>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><?php echo $rows['division_name_bng']; ?></td>
                <td><?php echo $rows['division_name_eng']; ?></td>
